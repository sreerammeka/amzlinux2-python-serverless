...
RUN curl --silent --location https://rpm.nodesource.com/setup_8.x | bash - && \
  yum install -y python3-devel python-pip libpython-dev gcc-c++ make mysql-devel nodejs nano findutils libyaml libyaml-devel libjpeg-devel python36-setuptools python36-devel git && \
